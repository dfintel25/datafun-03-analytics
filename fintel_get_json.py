...
fetched_folder_name = "tobacco_usage.json"
...
def main():
    ...
    """
    json_url = 'https://github.com/dfintel25/Sample-Data/raw/refs/heads/main/Tobacco_Usage_JSON'
    logger.info("Starting JSON fetch demonstration...")
    fetch_json_file(fetched_folder_name, "tobacco_usage.json", json_url)
