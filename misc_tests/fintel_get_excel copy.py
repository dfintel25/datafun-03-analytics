...
fetched_folder_name = "turfgrass.xls"
...
def main():
    ...
    """
    excel_url = 'https://github.com/dfintel25/Sample-Data/raw/refs/heads/main/All_Turfgrass_Data_ByLayer.xlsx'
    logger.info("Starting Excel fetch demonstration...")
    fetch_excel_file(fetched_folder_name, "turfgrass.xls", excel_url)
